...
const BUILD = /* core */ { allRenderFn: true, appendChildSlotFix: false, asyncLoading: true, attachStyles: true, cloneNodeFix: false, cmpDidLoad: false, cmpDidRender: false, cmpDidUnload: false, cmpDidUpdate: false, cmpShouldUpdate: false, cmpWillLoad: true, cmpWillRender: false, cmpWillUpdate: false, connectedCallback: false, constructableCSS: false, cssAnnotations: true, cssVarShim: false, devTools: false, disconnectedCallback: false, dynamicImportShim: false, element: false, event: false, hasRenderFn: true, hostListener: false, hostListenerTarget: false, hostListenerTargetBody: false, hostListenerTargetDocument: false, hostListenerTargetParent: false, hostListenerTargetWindow: false, hotModuleReplacement: false, hydrateClientSide: true, hydrateServerSide: true, hydratedAttribute: false, hydratedClass: true, isDebug: false, isDev: false, isTesting: false, lazyLoad: true, lifecycle: true, lifecycleDOMEvents: false, member: true, method: false, mode: false, observeAttribute: true, profile: false, prop: true, propBoolean: true, propMutable: false, propNumber: false, propString: true, reflect: false, safari10: false, scoped: false, scriptDataOpts: false, shadowDelegatesFocus: false, shadowDom: true, shadowDomShim: true, slot: true, slotChildNodesFix: false, slotRelocation: true, state: false, style: true, svg: false, taskQueue: true, updatable: true, vdomAttribute: true, vdomClass: true, vdomFunctional: false, vdomKey: false, vdomListener: false, vdomPropOrAttr: true, vdomRef: false, vdomRender: true, vdomStyle: false, vdomText: true, vdomXlink: false, watchCallback: false };
...
const rjContainerCss = "/*!@:host*/.sc-rj-container-h{display:inline}/*!@:host(.full-width)*/.full-width.sc-rj-container-h{display:flex;padding:0 16px;width:100%}";
...
class Container {
  ...
  static get style() { return rjContainerCss; }
  static get cmpMeta() { return {
    "$flags$": 9,
    "$tagName$": "rj-container",
    "$members$": {
...
const rjNavigationPanelCss = "/*!@html*/html.sc-rj-navigation-panel{line-height:1.15;-webkit-text-size-adjust:100%}/*!@body*/body.sc-rj-navigation-panel{margin:0}/*!@main*/main.sc-rj-navigation-panel{display:block}/*!@h1*/h1.sc-rj-navigation-panel{font-size:2em;margin:0.67em 0}/*!@hr*/hr.sc-rj-navigation-panel{box-sizing:content-box;height:0;overflow:visible}/*!@pre*/pre.sc-rj-navigation-panel{font-family:monospace, monospace;font-size:1em}/*!@a*/a.sc-rj-navigation-panel{background-color:transparent}/*!@abbr[title]*/abbr[title].sc-rj-navigation-panel{border-bottom:none;text-decoration:underline;text-decoration:underline dotted}/*!@b,\nstrong*/b.sc-rj-navigation-panel,strong.sc-rj-navigation-panel{font-weight:bolder}/*!@code,\nkbd,\nsamp*/code.sc-rj-navigation-panel,kbd.sc-rj-navigation-panel,samp.sc-rj-navigation-panel{font-family:monospace, monospace;font-size:1em}/*!@small*/small.sc-rj-navigation-panel{font-size:80%}/*!@sub,\nsup*/sub.sc-rj-navigation-panel,sup.sc-rj-navigation-panel{font-size:75%;line-height:0;position:relative;vertical-align:baseline}/*!@sub*/sub.sc-rj-navigation-panel{bottom:-0.25em}/*!@sup*/sup.sc-rj-navigation-panel{top:-0.5em}/*!@img*/img.sc-rj-navigation-panel{border-style:none}/*!@button,\ninput,\noptgroup,\nselect,\ntextarea*/button.sc-rj-navigation-panel,input.sc-rj-navigation-panel,optgroup.sc-rj-navigation-panel,select.sc-rj-navigation-panel,textarea.sc-rj-navigation-panel{font-family:inherit;font-size:100%;line-height:1.15;margin:0}/*!@button,\ninput*/button.sc-rj-navigation-panel,input.sc-rj-navigation-panel{overflow:visible}/*!@button,\nselect*/button.sc-rj-navigation-panel,select.sc-rj-navigation-panel{text-transform:none}/*!@button,\n[type=\"button\"],\n[type=\"reset\"],\n[type=\"submit\"]*/button.sc-rj-navigation-panel,[type=\"button\"].sc-rj-navigation-panel,[type=\"reset\"].sc-rj-navigation-panel,[type=\"submit\"].sc-rj-navigation-panel{-webkit-appearance:button}/*!@button::-moz-focus-inner,\n[type=\"button\"]::-moz-focus-inner,\n[type=\"reset\"]::-moz-focus-inner,\n[type=\"submit\"]::-moz-focus-inner*/button.sc-rj-navigation-panel::-moz-focus-inner,[type=\"button\"].sc-rj-navigation-panel::-moz-focus-inner,[type=\"reset\"].sc-rj-navigation-panel::-moz-focus-inner,[type=\"submit\"].sc-rj-navigation-panel::-moz-focus-inner{border-style:none;padding:0}/*!@button:-moz-focusring,\n[type=\"button\"]:-moz-focusring,\n[type=\"reset\"]:-moz-focusring,\n[type=\"submit\"]:-moz-focusring*/button.sc-rj-navigation-panel:-moz-focusring,[type=\"button\"].sc-rj-navigation-panel:-moz-focusring,[type=\"reset\"].sc-rj-navigation-panel:-moz-focusring,[type=\"submit\"].sc-rj-navigation-panel:-moz-focusring{outline:1px dotted ButtonText}/*!@fieldset*/fieldset.sc-rj-navigation-panel{padding:0.35em 0.75em 0.625em}/*!@legend*/legend.sc-rj-navigation-panel{box-sizing:border-box;color:inherit;display:table;max-width:100%;padding:0;white-space:normal}/*!@progress*/progress.sc-rj-navigation-panel{vertical-align:baseline}/*!@textarea*/textarea.sc-rj-navigation-panel{overflow:auto}/*!@[type=\"checkbox\"],\n[type=\"radio\"]*/[type=\"checkbox\"].sc-rj-navigation-panel,[type=\"radio\"].sc-rj-navigation-panel{box-sizing:border-box;padding:0}/*!@[type=\"number\"]::-webkit-inner-spin-button,\n[type=\"number\"]::-webkit-outer-spin-button*/[type=\"number\"].sc-rj-navigation-panel::-webkit-inner-spin-button,[type=\"number\"].sc-rj-navigation-panel::-webkit-outer-spin-button{height:auto}/*!@[type=\"search\"]*/[type=\"search\"].sc-rj-navigation-panel{-webkit-appearance:textfield;outline-offset:-2px}/*!@[type=\"search\"]::-webkit-search-decoration*/[type=\"search\"].sc-rj-navigation-panel::-webkit-search-decoration{-webkit-appearance:none}/*!@::-webkit-file-upload-button*/.sc-rj-navigation-panel::-webkit-file-upload-button{-webkit-appearance:button;font:inherit}/*!@details*/details.sc-rj-navigation-panel{display:block}/*!@summary*/summary.sc-rj-navigation-panel{display:list-item}/*!@template*/template.sc-rj-navigation-panel{display:none}/*!@[hidden]*/[hidden].sc-rj-navigation-panel{display:none}/*!@:host*/.sc-rj-navigation-panel-h{display:flex;background-color:#F4F4F4;border-bottom:1px solid #000;align-items:center}";
...
class NavigationPanel {
  ...
  render() {
    return (hAsync(Host, { class: {
        ["wrapper"]: true
      } }, hAsync("rj-container", { "full-width": this.fullWidth }, hAsync("p", null, this.appTitle))));
  }
  static get style() { return rjNavigationPanelCss; }
  static get cmpMeta() { return {
    "$flags$": 9,
    "$tagName$": "rj-navigation-panel",
    "$members$": {
      "fullWidth": [4, "full-width"],
